...
the `create-` prefix when resolving the scoped initializer.

This command only creates project files. Install dependencies and initialize version control yourself.
